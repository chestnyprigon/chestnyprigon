...
export default async function CatalogPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  const search: CatalogSearch = {
    ...
    minPrice: integer(get("minPrice"), 0), maxPrice: integer(get("maxPrice"), CATALOG_MAX_PRICE_USD), minMileage: integer(get("minMileage"), 0), maxMileage: integer(get("maxMileage"), CATALOG_MAX_MILEAGE_KM),
