export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="section catalog-teaser" id="catalog"><div><p className="eyebrow">Каталог Кореи</p><h2>Автомобили, которые<br />можно проверить</h2><p>Здесь появится живой каталог Encar с фильтрами, историей и расчётом доставки в Беларусь.</p></div><a className="button button-primary" href="#contacts">Подобрать автомобиль <span>↗</span></a></section>
